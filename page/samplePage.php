...
$employee_active = isset($_POST['ACTIVE']) ? 'true' : 'false';

if (strlen($employee_name) || strlen($employee_address)) {
  AddEmployee($connection, $employee_name, $employee_address, $employee_active);
}
...
function AddEmployee($connection, $name, $address, $active) {
   $n = pg_escape_string($name);
   $a = pg_escape_string($address);
   $act = pg_escape_string($active);
   echo "Forming Query";
   $query = "INSERT INTO EMPLOYEES (NAME, ADDRESS, ACTIVE) VALUES ('$n', '$a', '$act');";
